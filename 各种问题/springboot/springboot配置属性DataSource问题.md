---
title: springboot配置属性DataSource问题
date: 2019-05-24 21:35:37
tags: [springboot,DataSource,问题]
categories: 各种问题
---
...
![jenkins](springboot配置属性DataSource问题/springboot配置属性DataSource问题-1.png)



查找日志发现报错：
```
 Cause: org.springframework.jdbc.CannotGetJdbcConnectionException: Failed to obtain JDBC Connection; nested exception is com.alibaba.druid.pool.GetConnectionTimeoutException: wait millis 7217, active 8, maxActive 8, creating 0, runningSqlCount 2

```
分析日志应该是线程数不够，默认是8，重新设置为30，如下：
